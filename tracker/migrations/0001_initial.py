# Generated by Django 2.0 on 2017-12-29 22:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=150)),
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tracker.Board')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='PLN', max_digits=11)),
        ...
        migrations.AddField(
            model_name='spending',
            name='sub_category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='tracker.SubCategory'),
        ),
        migrations.AddField(
            model_name='board',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tracker.Profile'),
        ),
    ]
